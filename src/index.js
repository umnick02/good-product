...
const products = [
    {
        ...
        img: 'bread_3.jpg',
        ingredients: 'мука ржаная, мука обдирная, закваска, вода, солод ячменный, соль пищевая йодированная',
        expiry: '72 часа',
        cert: 'СТБ-639',
        weight: '350 г',
        price: {rub: '0', cent: '90'}
    },
    {
        ...
        img: 'bread_2.jpg',
        ingredients: 'мука ржаная, мука обдирная, закваска, вода, семена тыквы, семена льна, семена подсолнечника, кунжут, солод ячменный, соль пищевая йодированная, кориандр',
        expiry: '72 часа',
        cert: 'СТБ-639',
        weight: '350 г',
        price: {rub: '1', cent: '05'}
